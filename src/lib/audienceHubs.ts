...
export const audienceHubs: readonly AudienceHub[] = [
  {
    ...
    galleryImage: siteImages.coitGardenLawn,
    galleryImageAlt: "A garden path through flowering beds toward a lawn and white home",
    aboutImage: siteImages.coitSunroomLawn,
    aboutImageAlt: "A striped backyard lawn and planting beds in front of a white sunroom",
  ...
  },
  {
    ...
    galleryImageAlt: "A striped lawn looking toward a white porch and planting beds",
    aboutImage: siteImages.coitFlagstoneGarden,
    aboutImageAlt: "A flagstone path through hostas and flowering beds toward the lawn",
