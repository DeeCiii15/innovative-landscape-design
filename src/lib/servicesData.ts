...
export const services: ServiceDef[] = [
  ...
  },
  {
    ...
    galleryImage: siteImages.coitSunroomLawn,
    galleryImageAlt: "A striped lawn after turf work, with planting beds and a white sunroom",
    icon: "landscaping",
    highlights: [SERVICE_HIGHLIGHTS.suppliers],
  },
  {
    ...
    galleryImageAlt: "Herringbone brick courtyard with stone edging, planters, and planting beds",
    icon: "hardscapes",
  ...
  },
  {
    ...
    galleryImage: siteImages.coitDripUrn,
    galleryImageAlt: "Drip irrigation in a stone planter with pots and seasonal plantings",
    heroImage: siteImages.coitDripUrn,
    heroImageAlt: "Drip irrigation in a stone planter with pots and seasonal plantings",
    aboutImage: siteImages.coitDripUrn,
    aboutImageAlt: "Drip lines watering new plantings in a raised stone bed",
    icon: "irrigation",
  ...
  },
  {
    ...
    galleryImage: siteImages.coitLawnFramed,
    galleryImageAlt: "A full property with striped lawn, beds, and trees kept on one plan",
    icon: "maintenance",
  ...
  },
  {
    ...
    aboutImageAlt: "Striped lawn after professional mowing in Florence, SC",
    heroImage: siteImages.coitLawnAxis,
    heroImageAlt: "A striped lawn looking toward a white porch after professional mowing",
    icon: "lawn",
    highlights: [SERVICE_HIGHLIGHTS.eliteTurf],
  },
  {
  ...
  },
  {
    ...
    galleryImage: siteImages.coitColorPalms,
    galleryImageAlt: "Seasonal color planting with coleus, begonias, and chartreuse groundcover",
    icon: "garden",
    highlights: [SERVICE_HIGHLIGHTS.suppliers],
  },
  {
    ...
    galleryImage: siteImages.coitFlagstoneGarden,
    galleryImageAlt: "A flagstone garden path through hostas, silver foliage, and flowering beds",
    icon: "garden",
    highlights: [SERVICE_HIGHLIGHTS.suppliers],
  },
  {
    ...
    galleryImageAlt: "A healthy striped lawn with planting beds and a crepe myrtle",
    icon: "lawn",
    highlights: [SERVICE_HIGHLIGHTS.eliteTurf],
  },
  {
    ...
    galleryImage: siteImages.coitMulchBed,
    galleryImageAlt: "A mulched planting bed of irises beside a stone walk",
    icon: "garden",
    highlights: [SERVICE_HIGHLIGHTS.suppliers],
  },
  {
    ...
    galleryImage: siteImages.coitShapedBed,
    galleryImageAlt: "Shaped hedges and a color bed kept in scale with the walk and lawn",
    aboutImage: siteImages.coitShapedBed,
    aboutImageAlt: "Shaped hedges and a color bed kept in scale with the walk and lawn",
    heroImage: siteImages.coitPorchOverview,
    heroImageAlt: "A maintained garden and lawn seen from the porch, with shrubs kept in scale",
    icon: "garden",
  },
];
