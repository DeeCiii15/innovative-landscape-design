...
export const siteImages = {
  ...
  aboutBackyard: `${SITE_IMAGES_PATH}/about-sunroom.jpg`,
  aboutGardenBed: `${SITE_IMAGES_PATH}/about-color-bed.jpg`,
  ...
  coitHero: `${SITE_IMAGES_PATH}/coit-path-hero.jpg`,
  coitLawnHero: `${SITE_IMAGES_PATH}/coit-home-hero.jpg`,
  coitLawnAxis: `${SITE_IMAGES_PATH}/coit-lawn-view.jpg`,
  coitSunroomLawn: `${SITE_IMAGES_PATH}/coit-sunroom.jpg`,
  coitColorPalms: `${SITE_IMAGES_PATH}/coit-color-palms.jpg`,
  coitCourtyard: `${SITE_IMAGES_PATH}/coit-brick-courtyard.jpg`,
  coitFlagstoneGarden: `${SITE_IMAGES_PATH}/coit-flagstone-garden.jpg`,
  coitSteppingStones: `${SITE_IMAGES_PATH}/coit-stepping-stones.jpg`,
  coitMulchBed: `${SITE_IMAGES_PATH}/coit-mulch-bed.jpg`,
  coitDripUrn: `${SITE_IMAGES_PATH}/coit-irrigation-urn.jpg`,
  coitDriveIsland: `${SITE_IMAGES_PATH}/coit-entry-island.jpg`,
  coitShapedBed: `${SITE_IMAGES_PATH}/coit-shaped-bed.jpg`,
  coitLawnFramed: `${SITE_IMAGES_PATH}/coit-lawn-garden.jpg`,
...
export const projectImages = {
  ...
  coitPorch: `${COIT}/photo-05.jpg`,
  coitColorWall: `${COIT}/photo-07.jpg`,
  coitPlanter: `${COIT}/photo-12.jpg`,
