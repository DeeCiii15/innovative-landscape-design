...
const SKIP =
  ".hero, .page-hero, .project-hero, .home-aerial, .site-header, .process-story, .photo-collage, .welcome-line-wrap, .service-split, .reveal, .nav-mega, .reviews__actions, .reviews__grid, .trusted-by__item, .trusted-by__row, .trusted-by__viewport, .portfolio-marquee, .portfolio-marquee__band, .portfolio-marquee__head";
